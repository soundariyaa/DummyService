...
public class StorageException(ProblemDetails problemDetails, Exception innerException)
    : BaseException(problemDetails, innerException)
{
    public StorageException(ProblemDetails problemDetails) : this(problemDetails, new Exception()) { }
