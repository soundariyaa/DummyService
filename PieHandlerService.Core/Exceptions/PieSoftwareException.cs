...
public class PieSoftwareException(ProblemDetails problemDetails, Exception innerException)
    : BaseException(problemDetails, innerException)
{
    public PieSoftwareException(ProblemDetails problemDetails) : this(problemDetails, new Exception()) { }
